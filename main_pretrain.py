...
def get_args_parser():
    parser = argparse.ArgumentParser('SAIM pre-training', add_help=False)
...
def main(args):
    ...
    # define the model
    model = models_saim.__dict__[args.model](query_depth=args.query_depth, share_weight=args.share_weight,
                                             prediction_head_type=args.prediction_head_type,
                                             gaussian_kernel_size=args.gaussian_kernel_size,
                                             gaussian_sigma=args.gaussian_sigma,
                                             loss_type=args.loss_type, norm_pix_loss=args.norm_pix_loss)
